...
export const fr: I18nDictionary = {
  ...
  "opencode_restart.remote_configured": "Serveur configuré à distance.",
  "opencode_restart.stop_error": "❌ Échec de l'arrêt : {error}",
  "opencode_restart.start_error": "❌ Échec du démarrage : {error}",
  "opencode_restart.not_ready": "⚠️ Serveur non prêt après redémarrage (PID {pid}).",
  "opencode_restart.success": "✅ Serveur redémarré (PID {pid}, v{version}).",
  "opencode_restart.success_ssh": "✅ SSH déconnecté et reconnecté.",
  "opencode_restart.ssh_reconnect_error": "❌ Reconnexion SSH échouée : {error}",
  "opencode_restart.error": "❌ Erreur lors du redémarrage.",
};
