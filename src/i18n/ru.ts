...
export const ru: I18nDictionary = {
  ...
  "cmd.description.opencode_restart": "Перезапустить сервер OpenCode",
  "opencode_restart.restarting": "⏳ Перезапуск сервера OpenCode…",
  "opencode_restart.remote_configured": "Сервер OpenCode настроен удалённо.",
  "opencode_restart.stop_error": "❌ Ошибка остановки: {error}",
  "opencode_restart.start_error": "❌ Ошибка запуска: {error}",
  "opencode_restart.not_ready": "⚠️ Сервер не готов после перезапуска (PID {pid}).",
  "opencode_restart.success": "✅ Сервер перезапущен (PID {pid}, версия {version}).",
  "opencode_restart.success_ssh": "✅ SSH отключён и переподключён.",
  "opencode_restart.ssh_reconnect_error": "❌ Ошибка переподключения SSH: {error}",
  "opencode_restart.error": "❌ Ошибка при перезапуске.",
};
