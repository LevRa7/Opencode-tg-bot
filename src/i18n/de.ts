...
export const de: I18nDictionary = {
  ...
  "opencode_restart.remote_configured": "OpenCode Server ist remote konfiguriert.",
  "opencode_restart.stop_error": "❌ Server-Stopp fehlgeschlagen: {error}",
  "opencode_restart.start_error": "❌ Server-Start fehlgeschlagen: {error}",
  "opencode_restart.not_ready": "⚠️ Server nach Neustart nicht bereit (PID {pid}).",
  "opencode_restart.success": "✅ Server erfolgreich neu gestartet (PID {pid}, v{version}).",
  "opencode_restart.success_ssh": "✅ SSH getrennt und neu verbunden.",
  "opencode_restart.ssh_reconnect_error": "❌ SSH-Wiederverbindung fehlgeschlagen: {error}",
  "opencode_restart.error": "❌ Fehler beim Neustart.",
};
