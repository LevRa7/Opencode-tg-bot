export const en = {
  ...
  "open.subfolder_few": "{count} subfolders",
  ...
  "cmd.description.revert": "Revert session to replied message",
  "cmd.description.del": "Delete replied message",
  "revert.no_reply": "Reply to a message with /revert to rollback to it.",
  "revert.no_session": "No active session.",
  "revert.error": "Failed to revert session.",
  "revert.success": "Session reverted. Messages deleted from topic.",
  "del.no_reply": "Reply to a message with /del to delete it.",
  "del.success": "Message deleted.",
  "del.error": "Failed to delete message.",
  "bookmark.saved": "❤️ Message bookmarked.",
  "bookmark.removed": "Bookmark removed.",
  "react.abort": "💔 Operation aborted.",
  "cmd.description.memory": "Show project memory (MEMORY.md)",
  "memory.empty": "MEMORY.md not found. Use /memory add <text> to create.",
  "memory.added": "Entry added to MEMORY.md.",
  "memory.usage": "Usage: /memory [add <text>] — show or add to project memory.",
  "memory.show": "Project memory (MEMORY.md):",
  "memory.show_truncated": "(showing first 2000 characters)",
  "upload.read_full_on_telegraph": "\uD83D\uDCD6 Read full response on Telegraph",

  "server_web.not_configured": "Web panel is not configured. Use /start to set it up.",
  "server_web.title": "OpenCode Web Panel",
  "server_web.label_url": "URL:",
  "server_web.label_login": "Login:",
  "server_web.label_password": "Password:",
  "server_web.label_type": "Type:",
  "server_web.label_host": "Host:",
  "server_web.button.open": "Open",
  "server_web.button.change_password": "Change Password",
  "server_web.password_updated": "Password updated, restarting server\u2026",
  "server_web.new_password_message": "New password: <code>{password}</code>\n\n<i>Restarting server\u2026</i>",
  "server_web.error_not_configured": "Error: web panel is not configured",

  "onboarding.setup_web_panel": "\uD83D\uDD27 Set up web panel",
  "onboarding.skip": "\u23ED\uFE0F Skip",
  "onboarding.prompt": "Set up OpenCode web panel access?",
  "onboarding.your_web_panel": "Your OpenCode web panel:",
  "onboarding.save_password_hint": "Save your password. You can change it later via /server.",
  ...
  "vm.onboarding.vm_ready": "✅ Access approved. IPv6: {ipv6}. You can now use the agent.",
