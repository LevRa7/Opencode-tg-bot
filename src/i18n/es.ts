...
export const es: I18nDictionary = {
  ...
  "opencode_restart.restarting": "⏳ Reiniciando servidor OpenCode…",
  "opencode_restart.remote_configured": "Servidor OpenCode configurado remotamente.",
  "opencode_restart.stop_error": "❌ Error al detener: {error}",
  "opencode_restart.start_error": "❌ Error al iniciar: {error}",
  "opencode_restart.not_ready": "⚠️ Servidor no listo tras reinicio (PID {pid}).",
  "opencode_restart.success": "✅ Servidor reiniciado (PID {pid}, v{version}).",
  "opencode_restart.success_ssh": "✅ SSH desconectado y reconectado.",
  "opencode_restart.ssh_reconnect_error": "❌ Reconexión SSH fallida: {error}",
  "opencode_restart.error": "❌ Error durante el reinicio.",
};
