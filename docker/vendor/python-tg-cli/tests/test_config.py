...
class TestConfig:
    ...
    def test_get_auth_paths_for_tg_id(self, monkeypatch):
        monkeypatch.setenv("TG_ID", "6931112349")
        monkeypatch.setenv("TG_WORKSPACE_ROOT", "/home/me/Workspaces")
        import tg_cli.config as cfg

        assert cfg.get_session_path() == "/home/me/Workspaces/6931112349/.tg-cli/6931112349.session.string"
        assert cfg.get_token_path() == "/home/me/Workspaces/6931112349/.tg-cli/6931112349.token"
